...
public class BT_DeviceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b_t__device_list);

        // Set result CANCELED in case the user backs out
        setResult(Activity.RESULT_CANCELED);

        // Initialize the button to perform device discovery
        ImageButton scanButton = (ImageButton) findViewById(R.id.scan_btn);
        ...
        if (pairedDevices.size() > 0) {
            findViewById(R.id.pairedDevice).setVisibility(View.VISIBLE);
    ...
    private void doDiscovery() {
        ...
        findViewById(R.id.newDevice).setVisibility(View.VISIBLE);
