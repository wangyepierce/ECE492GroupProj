/*
 * Our group learned this codes from "BlueTerm"
 */
...
public class BluetoothSerialService {
     ...
     */
    public BluetoothSerialService(Context context, Handler handler, View emulatorView) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(HomeActivity.TOAST, mContext.getString(R.string.toast_unable_to_connect) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(HomeActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(HomeActivity.TOAST, mContext.getString(R.string.toast_connection_lost) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
       ...
       //             mEmulatorView.write(buffer, bytes);
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(HomeActivity.MESSAGE_WRITE, buffer.length, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
